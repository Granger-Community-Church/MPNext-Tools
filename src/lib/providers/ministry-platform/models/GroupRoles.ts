...
export interface GroupRoles {
  ...
  Auto_Add_Group?: number /* 32-bit integer */ | null; // Foreign Key -> Groups.Group_ID

  Role_When_Auto_Added?: number /* 32-bit integer */ | null; // Foreign Key -> Group_Roles.Group_Role_ID
