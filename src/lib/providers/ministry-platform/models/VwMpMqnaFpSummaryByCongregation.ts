/**
 * Interface for vw_mp_mqna_fp_summary_by_congregation
* Table: vw_mp_mqna_fp_summary_by_congregation
 * Access Level: Read
 * Special Permissions: FileAttach, DataExport, SecureRecord
 * Generated from column metadata
 */
export interface VwMpMqnaFpSummaryByCongregation {
...
export type VwMpMqnaFpSummaryByCongregationRecord = VwMpMqnaFpSummaryByCongregation;
