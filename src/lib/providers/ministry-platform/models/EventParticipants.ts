...
export interface EventParticipants {
  ...
  _PlusOne_Registration?: number /* 32-bit integer */ | null; // Foreign Key -> Event_Participants.Event_Participant_ID, Read Only

  _Invoice_ID?: number /* 32-bit integer */ | null; // Foreign Key -> Invoices.Invoice_ID, Read Only
}
