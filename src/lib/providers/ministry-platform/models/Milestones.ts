...
export interface Milestones {
  ...
  Accomplished_Message?: number /* 32-bit integer */ | null; // Foreign Key -> dp_Communications.Communication_ID
  ...
  Circle_Milestone?: number /* 32-bit integer */ | null; // Foreign Key -> Milestones.Milestone_ID
}
