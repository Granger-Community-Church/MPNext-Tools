...
export interface Households {
   ...
   */
  Authorized_Pickup_Note?: string /* max 100 chars */ | null;
  ...
  MC3_Delivery_Start?: string /* ISO datetime */ | null;

  MC3_Delivery_End?: string /* ISO datetime */ | null;

  Last_Assistance_Review?: string /* ISO date (YYYY-MM-DD) */ | null;

  Assistance_Category_ID?: number /* 32-bit integer */ | null; // Foreign Key -> Assistance_Categories.Assistance_Category_ID
  ...
  _First_General_Fund_Donation?: string /* ISO datetime */ | null; // Read Only
}
