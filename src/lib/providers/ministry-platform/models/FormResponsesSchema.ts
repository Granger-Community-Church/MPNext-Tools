...
export const FormResponsesSchema = z.object({
  ...
  Request_Approved: z.boolean().nullable(),
  Note_to_Requestor: z.string().max(500).nullable(),
  Discount_Amount: z.number().nullable(),
  Date_Notification_Sent: z.string().datetime().nullable(),
  Promo_Code: z.string().max(20).nullable(),
  Discount_End_Date: z.string().datetime().nullable(),
  Internal_Notes: z.string().max(2147483647).nullable(),
  ...
  Testimony_Approved: z.boolean().nullable(),
  Secondary_Contact_ID: z.number().int().nullable(),
});
