...
export interface FormResponses {
   ...
   */
  Note_to_Requestor?: string /* max 500 chars */ | null;

  Discount_Amount?: number /* currency amount */ | null;

  Date_Notification_Sent?: string /* ISO date (YYYY-MM-DD) */ | null;
  ...
  Discount_End_Date?: string /* ISO datetime */ | null;

  /**
   * Max length: 2147483647 characters
   */
  Internal_Notes?: string /* max 2147483647 chars */ | null;
  ...
  Testimony_Approved?: boolean | null;

  Secondary_Contact_ID?: number /* 32-bit integer */ | null; // Foreign Key -> Contacts.Contact_ID
}
